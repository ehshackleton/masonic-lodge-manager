...
module BrandHelper
  ...
  HERO_LOGO = %w[logo-amenti-hero.png logo-amenti-card.png logo-amenti.png].freeze
  MARK_LOGO = %w[logo-amenti-badge.png logo-amenti-mark.png insignia-sello.png].freeze
