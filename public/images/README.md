...
Clasificación por defecto: **PUBLICO** solo si hay autorización explícita.
...
| `logo-amenti-mark.png` | Marca compacta |
| `logo-amenti-badge.png` | Badge con plato navy + aro oro (nav/favicon) |
| `galeria_*.webp` | Ambientación del sitio (no interior ritual) |
